...
class ProductDisplay extends React.Component {
    ...
    ColourChanged = (e) => {
        ...
        if (!colorIncluded) {
            ...
            var newproducts = [];
            console.log(colorRemovedArray.length)
                    ...
                    <Card style={{ width: '18rem', marginLeft: "1rem" }}>
                        <ListGroup variant="flush">
                            ...
                            <ListGroup.Item><span>
                                <label>Brand</label>
                                <Form inline>
                                    <FormControl type="text" placeholder="Search Brand" className="mr-sm-2"  On/>
                                    <BsSearch ></BsSearch>
                                </Form>
                            </span></ListGroup.Item>
                            <ListGroup.Item>
                ...
                <div className="row">
                    <div style={{ width: "100%", marginLeft: "1rem" }}>
                        <Navbar bg="light" variant="light">
                            <Navbar>Sort By {' '}Relevance</Navbar>
                            <Nav>
                    ...
                    {this.state.products.map((item, index) =>
                        (
                            <div className="col-sm-4">
                                <Card style={{ width: '18rem', height: '22rem', marginBottom: "1rem" }}>
